...
<Tabs groupId="sdk-type">
  ...
  <TabItem value="typescript-kit" label="TypeScript Kit">
    ...
    const { quote: increaseQuote, instructions: increaseInstructions, callback: increaseLiquidity } = await increaseLiquidityInstructions(
        devnetRpc,
        positionMint,
        param,
        100,
    ...
    const { quote: decreaseQuote, instructions: decreaseInstructions, callback: decreaseLiquidity } = await decreaseLiquidityInstructions(
        devnetRpc,
        positionMint,
        param,
        100,
    ...
    const txIdIncrease = await increaseLiquidity();
    console.log(`Transaction ID: ${txIdIncrease}`);

    const txIdDecrease = await decreaseLiquidity();
