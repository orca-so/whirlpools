      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        >
          ...
          <div className="flex flex-col space-y-1.5 text-center sm:text-left mb-4">
            <h3 className="text-lg font-semibold leading-none tracking-tight text-gray-900">Connect Wallet</h3>
            <p className="text-sm text-gray-600">Select a wallet to connect to.</p>
          </div>
