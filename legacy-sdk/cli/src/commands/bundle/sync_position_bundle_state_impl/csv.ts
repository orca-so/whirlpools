...
import { MAX_TICK_INDEX, MIN_TICK_INDEX, POSITION_BUNDLE_SIZE } from "@orca-so/whirlpools-sdk";

export type PositionBundleOpenState = { state: "open"; lowerTickIndex: number; upperTickIndex: number; liquidity: BN };
export type PositionBundleClosedState = { state: "closed" };
export type PositionBundleStateItem = PositionBundleOpenState | PositionBundleClosedState;

export function readPositionBundleStateCsv(positionBundleStateCsvPath: string, tickSpacing: number): PositionBundleStateItem[] {
