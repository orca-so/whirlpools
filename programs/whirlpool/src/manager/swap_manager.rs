...
mod adaptive_fee_tests {
        ...
        fn hit_max_sqrt_price_b_to_a() {
            ...
            let expected =
                get_expected_result(
                    ...
                    swap_test_info.whirlpool.sqrt_price,
                    swap_test_info.whirlpool.liquidity,
                    [(439296 - 2816, p1_liquidity), (443584, -p1_liquidity)].into_iter().collect(),
                    433664 + 64,
                    af_constants.tick_group_size,
                    swap_test_info.trade_amount,
                    static_fee_rate,
        ...
        fn from_max_sqrt_price_a_to_b() {
            ...
            let expected =
                get_expected_result(
                    ...
                    swap_test_info.whirlpool.sqrt_price,
                    swap_test_info.whirlpool.liquidity,
                    [(443584, -p1_liquidity), (439296 - 2816, p1_liquidity)].into_iter().collect(),
                    443584,
                    af_constants.tick_group_size,
                    swap_test_info.trade_amount,
                    static_fee_rate,
        ...
        fn hit_max_sqrt_price_b_to_a() {
            ...
            let expected =
                get_expected_result(
                    ...
                    swap_test_info.whirlpool.sqrt_price,
                    swap_test_info.whirlpool.liquidity,
                    [(443608 - 44, p1_liquidity), (443636, -p1_liquidity)].into_iter().collect(),
                    443520 + 1,
                    af_constants.tick_group_size,
                    swap_test_info.trade_amount,
                    static_fee_rate,
        ...
        fn from_max_sqrt_price_a_to_b() {
            ...
            let expected =
                get_expected_result(
                    ...
                    swap_test_info.whirlpool.sqrt_price,
                    swap_test_info.whirlpool.liquidity,
                    [(443636, -p1_liquidity), (443608 - 44, p1_liquidity)].into_iter().collect(),
                    443636,
                    af_constants.tick_group_size,
                    swap_test_info.trade_amount,
                    static_fee_rate,
    ...
    mod ts_32896 {
        ...
        /// notes:
        /// - first tick group index should be 0
        /// - the delta of tick group index for [-32896, 0] range is 1.
        ///
        /// -2894848                   0                          2894848
        ...
        // TODO: add test cases for shortcut
    }
}
