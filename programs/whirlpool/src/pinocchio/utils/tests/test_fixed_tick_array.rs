use crate::pinocchio::{state::whirlpool::{MemoryMappedTick, loader::LoadedTickArrayMut}, utils::tests::test_account_info::TestAccountInfo};
...
impl TestMemoryMappedFixedTickArray {
    pub fn new(start_tick_index: i32, initialized_offsets: Vec<usize>) -> Self {
        let mut test_account_info = TestAccountInfo::new_fixed_tick_array(
          &Pubkey::default(),
          start_tick_index,
        ).writable();
