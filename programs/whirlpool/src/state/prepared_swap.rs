...
use crate::{
    ...
    state::{AdaptiveFeeVariables, NUM_REWARDS, TICK_ARRAY_SIZE_USIZE},
};
...
impl PreparedSwapPendingUpdates {
    pub const LEN: usize =
        PendingPostSwapUpdate::LEN + 2 + PendingTickUpdate::LEN * MAX_PENDING_TICK_UPDATES_LEN; // 9947
}
...
impl PreparedSwap {
    pub const LEN: usize = 8
        + 2
        + 1
        + PreparedSwapPrecondition::LEN
        + PreparedSwapPendingUpdates::LEN
        + PREPARED_SWAP_RESERVED_BYTES;
    ...
    pub fn add_pending_tick_update(&mut self, update: PendingTickUpdate) {
        ...
        self.pending_updates.pending_tick_updates
            [self.pending_updates.pending_tick_updates_len as usize] = update;
        self.pending_updates.pending_tick_updates_len += 1;
    }

    pub fn set_pending_post_swap_update(&mut self, update: &PostSwapUpdate) {
    ...
    pub fn set_state(&mut self, state: PreparedSwapState) {
...
mod prepared_swap_functions_tests {
    ...
    fn test_initialize_fail_invalid_nonce() {
        ...
        assert_eq!(
            result.unwrap_err(),
            ErrorCode::PreparedSwapNonceMaxExceeded.into()
        );
    }
    ...
    fn test_set_pending_post_swap_update_adaptive_fee_info_is_some() {
        ...
        let expect_post_swap_update = PendingPostSwapUpdate {
            ...
            next_adaptive_fee_variables: post_swap_update
    ...
    fn test_validate_for_commit_fail_version_mismatch() {
        ...
        assert_eq!(
            result.unwrap_err(),
            ErrorCode::PreparedSwapVersionMismatch.into()
        );
    }
    ...
    fn test_validate_for_commit_fail_state_not_prepared() {
        ...
        assert_eq!(
            result.unwrap_err(),
            ErrorCode::PreparedSwapNotPrepared.into()
        );
    }
    ...
    fn test_validate_for_commit_fail_precondition_mismatch() {
        ...
        // swap_tick_sequence_len mismatch
        let result = prepared_swap.validate_for_commit(
            authority,
            whirlpool_address,
            whirlpool_state_sequence,
...
mod data_layout_tests {
    ...
    fn test_struct_size() {
        assert_eq!(
            size_of::<PendingPostSwapUpdate>(),
            PendingPostSwapUpdate::LEN
        );
        assert_eq!(size_of::<PendingTickUpdate>(), PendingTickUpdate::LEN);
        assert_eq!(
            size_of::<PreparedSwapPrecondition>(),
            PreparedSwapPrecondition::LEN
        );
        assert_eq!(
            size_of::<PreparedSwapPendingUpdates>(),
            PreparedSwapPendingUpdates::LEN
        );
        assert_eq!(size_of::<PreparedSwap>() + 8, PreparedSwap::LEN); // +8: discriminator
    }
    ...
    fn test_prepared_swap_data_layout() {
        ...
        let pending_post_swap_update_next_fee_growth_global =
            0x11223344443322119988776666778899u128;
        ...
        let pending_post_swap_update_next_af_var_last_reference_update_timestamp =
        ...
        pending_tick_update[5..21]
            .copy_from_slice(&pending_tick_update_next_fee_growth_outside_a.to_le_bytes());
        pending_tick_update[21..37]
            .copy_from_slice(&pending_tick_update_next_fee_growth_outside_b.to_le_bytes());
        ...
        offset += 32;
        precondition_data[offset..offset + 4]
            .copy_from_slice(&precondition_whirlpool_state_sequence.to_le_bytes());
        offset += 4;
        ...
        precondition_data[offset..offset + 16]
            .copy_from_slice(&precondition_sqrt_price_limit.to_le_bytes());
        offset += 16;
        ...
        pending_updates_data[offset..offset + 8]
            .copy_from_slice(&pending_post_swap_update_amount_a.to_le_bytes());
        offset += 8;
        pending_updates_data[offset..offset + 8]
            .copy_from_slice(&pending_post_swap_update_amount_b.to_le_bytes());
        offset += 8;
        pending_updates_data[offset..offset + 8]
            .copy_from_slice(&pending_post_swap_update_lp_fee.to_le_bytes());
        offset += 8;
        pending_updates_data[offset..offset + 16]
            .copy_from_slice(&pending_post_swap_update_next_liquidity.to_le_bytes());
        offset += 16;
        pending_updates_data[offset..offset + 4]
            .copy_from_slice(&pending_post_swap_update_next_tick_index.to_le_bytes());
        offset += 4;
        pending_updates_data[offset..offset + 16]
            .copy_from_slice(&pending_post_swap_update_next_sqrt_price.to_le_bytes());
        offset += 16;
        pending_updates_data[offset..offset + 16]
            .copy_from_slice(&pending_post_swap_update_next_fee_growth_global.to_le_bytes());
        offset += 16;
        pending_post_swap_update_next_reward_growth_global
            .iter()
            .for_each(|v| {
        ...
        pending_updates_data[offset..offset + 8]
            .copy_from_slice(&pending_post_swap_update_next_protocol_fee.to_le_bytes());
        offset += 8;
        pending_updates_data[offset] = pending_post_swap_update_next_af_var_is_some as u8;
        offset += 1;
        pending_updates_data[offset..offset + 8].copy_from_slice(
            &pending_post_swap_update_next_af_var_last_reference_update_timestamp.to_le_bytes(),
        );
        offset += 8;
        pending_updates_data[offset..offset + 8].copy_from_slice(
            &pending_post_swap_update_next_af_var_last_major_swap_timestamp.to_le_bytes(),
        );
        offset += 8;
        pending_updates_data[offset..offset + 4].copy_from_slice(
            &pending_post_swap_update_next_af_var_volatility_reference.to_le_bytes(),
        );
        offset += 4;
        pending_updates_data[offset..offset + 4].copy_from_slice(
            &pending_post_swap_update_next_af_var_tick_group_index_reference.to_le_bytes(),
        );
        offset += 4;
        pending_updates_data[offset..offset + 4].copy_from_slice(
            &pending_post_swap_update_next_af_var_volatility_accumulator.to_le_bytes(),
        );
        offset += 4;
        offset += pending_post_swap_update_next_af_var_reserved.len();
        assert_eq!(offset, PendingPostSwapUpdate::LEN);
        // tick
        pending_updates_data[offset..offset + 2]
            .copy_from_slice(&pending_tick_updates_len.to_le_bytes());
        offset += 2;
        for _ in 0..MAX_PENDING_TICK_UPDATES_LEN {
            pending_updates_data[offset..offset + PendingTickUpdate::LEN]
                .copy_from_slice(&pending_tick_update);
        ...
        let mut prepared_swap_data = [0u8; PreparedSwap::LEN - 8];
        let mut offset = 0;
        prepared_swap_data[offset..offset + 2]
            .copy_from_slice(&prepared_swap_version.to_le_bytes());
        offset += 2;
        prepared_swap_data[offset] = prepared_swap_state;
        offset += 1;
        prepared_swap_data[offset..offset + PreparedSwapPrecondition::LEN]
            .copy_from_slice(&precondition_data);
        offset += PreparedSwapPrecondition::LEN;
        prepared_swap_data[offset..offset + PreparedSwapPendingUpdates::LEN]
            .copy_from_slice(&pending_updates_data);
        offset += PreparedSwapPendingUpdates::LEN;
        offset += prepared_swap_reserved.len();
        assert_eq!(offset, prepared_swap_data.len());
        assert_eq!(
            prepared_swap_data.len(),
            core::mem::size_of::<PreparedSwap>()
        );
        ...
        assert_eq!(
            read_whirlpool_state_sequence,
            precondition_whirlpool_state_sequence
        );
        let read_swap_tick_sequence_len = prepared_swap.precondition.swap_tick_sequence_len;
        assert_eq!(
        ...
        assert_eq!(
            read_amount_specified_is_input,
        ...
        // pendingg updates
        let read_amount_a = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .amount_a;
        assert_eq!(read_amount_a, pending_post_swap_update_amount_a);
        let read_amount_b = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .amount_b;
        assert_eq!(read_amount_b, pending_post_swap_update_amount_b);
        let read_lp_fee = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .lp_fee;
        assert_eq!(read_lp_fee, pending_post_swap_update_lp_fee);
        let read_next_liquidity = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_liquidity;
        assert_eq!(read_next_liquidity, pending_post_swap_update_next_liquidity);
        let read_next_tick_index = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_tick_index;
        assert_eq!(
            read_next_tick_index,
            pending_post_swap_update_next_tick_index
        );
        let read_next_sqrt_price = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_sqrt_price;
        assert_eq!(
            read_next_sqrt_price,
            pending_post_swap_update_next_sqrt_price
        );
        let read_next_fee_growth_global = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_fee_growth_global;
        assert_eq!(
            read_next_fee_growth_global,
            pending_post_swap_update_next_fee_growth_global
        );
        let read_next_reward_growth_global = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_reward_growth_global;
        assert_eq!(
            read_next_reward_growth_global,
            pending_post_swap_update_next_reward_growth_global
        );
        let read_next_protocol_fee = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_protocol_fee;
        assert_eq!(
            read_next_protocol_fee,
            pending_post_swap_update_next_protocol_fee
        );

        let read_is_some = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_adaptive_fee_variables_is_some;
        assert_eq!(read_is_some, pending_post_swap_update_next_af_var_is_some);
        let read_last_reference_update_timestamp = prepared_swap
            .pending_updates
            .pending_post_swap_update
        ...
        assert_eq!(
            ...
            pending_post_swap_update_next_af_var_last_reference_update_timestamp
        );
        let read_last_major_swap_timestamp = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_adaptive_fee_variables
            .last_major_swap_timestamp;
        assert_eq!(
            read_last_major_swap_timestamp,
            pending_post_swap_update_next_af_var_last_major_swap_timestamp
        );
        let read_volatility_reference = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_adaptive_fee_variables
            .volatility_reference;
        assert_eq!(
            read_volatility_reference,
            pending_post_swap_update_next_af_var_volatility_reference
        );
        let read_tick_group_index_reference = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_adaptive_fee_variables
            .tick_group_index_reference;
        assert_eq!(
            read_tick_group_index_reference,
            pending_post_swap_update_next_af_var_tick_group_index_reference
        );
        let read_volatility_accumulator = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_adaptive_fee_variables
            .volatility_accumulator;
        assert_eq!(
            read_volatility_accumulator,
            pending_post_swap_update_next_af_var_volatility_accumulator
        );
        let read_reserved = prepared_swap
            .pending_updates
            .pending_post_swap_update
            .next_adaptive_fee_variables
            .reserved;
        ...
        for i in 0..MAX_PENDING_TICK_UPDATES_LEN {
            let read_array_index =
                prepared_swap.pending_updates.pending_tick_updates[i].array_index;
            ...
            let read_next_fee_growth_outside_a =
                prepared_swap.pending_updates.pending_tick_updates[i].next_fee_growth_outside_a;
            assert_eq!(
                read_next_fee_growth_outside_a,
                pending_tick_update_next_fee_growth_outside_a
            );
            let read_next_fee_growth_outside_b =
                prepared_swap.pending_updates.pending_tick_updates[i].next_fee_growth_outside_b;
            assert_eq!(
                read_next_fee_growth_outside_b,
                pending_tick_update_next_fee_growth_outside_b
            );
        }
    }
}
