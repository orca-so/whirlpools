...
mod data_layout_tests {
    ...
    fn test_whirlpool_data_layout() {
        ...
        assert_eq!(deserialized.reward_last_updated_timestamp, whirlpool_reward_last_updated_timestamp);
        for i in 0..NUM_REWARDS {
            ...
            assert_eq!(deserialized.reward_infos[i].emissions_per_second_x64, reward_info_emissions_per_second_x64);
            assert_eq!(deserialized.reward_infos[i].growth_global_x64, reward_info_growth_global_x64);
        }
