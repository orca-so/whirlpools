...
pub const COMMIT_SWAP_V2_DISCRIMINATOR: [u8; 8] = [103, 3, 90, 236, 177, 199, 147, 78];

/// Accounts.
#[derive(Debug)]
pub struct CommitSwapV2 {
...
impl CommitSwapV2 {
  pub fn instruction(&self, args: CommitSwapV2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CommitSwapV2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = CommitSwapV2InstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CommitSwapV2InstructionData {
            discriminator: [u8; 8],
                                    }

impl CommitSwapV2InstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [103, 3, 90, 236, 177, 199, 147, 78],
                                                                                        }
  }
...
impl Default for CommitSwapV2InstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CommitSwapV2InstructionArgs {
                  pub amount: u64,
...
impl CommitSwapV2InstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
/// Instruction builder for `CommitSwapV2`.
///
/// ### Accounts:
///
...
pub struct CommitSwapV2Builder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CommitSwapV2 {
          ...
          let args = CommitSwapV2InstructionArgs {
  ...
  /// `commit_swap_v2` CPI accounts.
  pub struct CommitSwapV2CpiAccounts<'a, 'b> {
...
/// `commit_swap_v2` CPI instruction.
pub struct CommitSwapV2Cpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: CommitSwapV2InstructionArgs,
  }

impl<'a, 'b> CommitSwapV2Cpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: CommitSwapV2CpiAccounts<'a, 'b>,
              args: CommitSwapV2InstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `CommitSwapV2` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` prepared_swap
          ...
          ///   7. `[]` token_mint_b
                ...
                ///   15. `[writable]` oracle
#[derive(Clone, Debug)]
pub struct CommitSwapV2CpiBuilder<'a, 'b> {
  instruction: Box<CommitSwapV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CommitSwapV2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CommitSwapV2CpiBuilderInstruction {
      __program: program,
              prepared_swap: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = CommitSwapV2Cpi {
...
#[derive(Clone, Debug)]
struct CommitSwapV2CpiBuilderInstruction<'a, 'b> {
