...
pub const RESET_POSITION_RANGE_DISCRIMINATOR: [u8; 8] = [164, 123, 180, 141, 194, 100, 160, 175];
...
impl ResetPositionRange {
  pub fn instruction(&self, args: ResetPositionRangeInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ResetPositionRangeInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = ResetPositionRangeInstructionData::new().try_to_vec().unwrap();
...
impl ResetPositionRangeInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
