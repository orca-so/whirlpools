...
pub const SET_TOKEN_BADGE_ATTRIBUTE_DISCRIMINATOR: [u8; 8] = [224, 88, 65, 33, 138, 147, 246, 137];
...
impl SetTokenBadgeAttribute {
  pub fn instruction(&self, args: SetTokenBadgeAttributeInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetTokenBadgeAttributeInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = SetTokenBadgeAttributeInstructionData::new().try_to_vec().unwrap();
...
impl SetTokenBadgeAttributeInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
