...
mod tests {
    ...
    fn test_get_whirlpool_address() {
        let whirlpools_config: Pubkey = "2LecshUwdy9xi7meFgHtFJQNSKk4KdTrcpvaB56dP2NQ"
            ...
            .try_into()
            .unwrap();
        let token_mint_a: Pubkey = "So11111111111111111111111111111111111111112"
            .from_base58()
            .unwrap()
            .try_into()
            .unwrap();
        let token_mint_b: Pubkey = "2b1kV6DkPAnxd5ixfnxCpjxmKwqjjaYmCZfHsFu24GXo"
            .from_base58()
            .unwrap()
            .try_into()
            .unwrap();
        let whirlpool: Pubkey = "JDQ9GDphXV5ENDrAQtRFvT98m3JwsVJJk8BYHoX8uTAg"
            .from_base58()
            .unwrap()
            .try_into()
            .unwrap();
