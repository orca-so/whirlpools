...
/// Convert a price into a sqrt priceX64, price has to be greater than 0.0.
...
/// * `i32` - The tick index
#[cfg_attr(feature = "wasm", wasm_expose)]
pub fn price_to_tick_index(price: f64, decimals_a: u8, decimals_b: u8) -> Result<i32, CoreError> {
    let sqrt_price = price_to_sqrt_price(price, decimals_a, decimals_b)?;
    Ok(sqrt_price_to_tick_index(sqrt_price))
}
...
mod tests {
    ...
    #[test]
    fn test_price_to_sqrt_price() -> Result<(), CoreError> {
    ...
    #[test]
    fn test_invert_price() -> Result<(), CoreError> {
        assert_relative_eq!(
    ...
    #[test]
    fn test_price_to_tick_index() -> Result<(), CoreError> {
    ...
    #[test]
    fn test_sol_usdc() -> Result<(), CoreError> {
    ...
    #[test]
    fn test_bonk_usdc() -> Result<(), CoreError> {
