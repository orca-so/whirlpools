...
describe("position-impl", () => {
  ...
  it("increase and decrease liquidity on position", async () => {
    ...
    const increase_quote = increaseLiquidityQuoteByInputToken_PriceSlippage(
      poolInitInfo.tokenMintB,
      new Decimal(70),
      lowerTick,
      upperTick,
  ...
  it("increase & decrease liquidity on position with a different destination, position wallet", async () => {
    ...
    const increaseQuoteFromOtherWallet = increaseLiquidityQuoteByInputToken_PriceSlippage(
      poolInitInfo.tokenMintB,
      new Decimal(80),
      lowerTick,
      upperTick,
