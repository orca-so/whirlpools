...
pub struct InitializePoolIxBuilder<'a> {
    svm: &'a mut LiteSVM,
    admin: &'a Keypair,
...
impl<'a> InitializePoolIxBuilder<'a> {
    pub fn new(
        svm: &'a mut LiteSVM,
        admin: &'a Keypair,
        whirlpools_config: Pubkey,
    ...
    pub fn run(mut self, step: u8) -> Self {
        ...
        let ixs = program
            .request()
            .accounts(whirlpool_optimization::accounts::InitializePoolV2 {
            ...
            .args(whirlpool_optimization::instruction::InitializePoolV2 {
...
impl<'a> BaseBuilderTrait for InitializePoolIxBuilder<'a> {
