...
export function getFixedTickArrayEncoder(): FixedSizeEncoder<FixedTickArrayArgs> {
...
export function getFixedTickArrayDecoder(): FixedSizeDecoder<FixedTickArray> {
...
export function getFixedTickArrayCodec(): FixedSizeCodec<
  FixedTickArrayArgs,
  FixedTickArray
> {
