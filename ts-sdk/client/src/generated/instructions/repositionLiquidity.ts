...
export const REPOSITION_LIQUIDITY_DISCRIMINATOR = new Uint8Array([
  19, 2, 62, 174, 214, 130, 155, 62,
]);

export function getRepositionLiquidityDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REPOSITION_LIQUIDITY_DISCRIMINATOR,
  );
}

export type RepositionLiquidityInstruction<
...
export type RepositionLiquidityInstructionData = {
...
export type RepositionLiquidityInstructionDataArgs = {
  newTickLowerIndex: number;
  newTickUpperIndex: number;
...
export function getRepositionLiquidityInstructionDataEncoder(): Encoder<RepositionLiquidityInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: REPOSITION_LIQUIDITY_DISCRIMINATOR,
    }),
  );
}

export function getRepositionLiquidityInstructionDataDecoder(): Decoder<RepositionLiquidityInstructionData> {
...
export function getRepositionLiquidityInstructionDataCodec(): Codec<
  RepositionLiquidityInstructionDataArgs,
  RepositionLiquidityInstructionData
> {
  return combineCodec(
    getRepositionLiquidityInstructionDataEncoder(),
    getRepositionLiquidityInstructionDataDecoder(),
  );
}
...
> = {
  ...
  newTickLowerIndex: RepositionLiquidityInstructionDataArgs["newTickLowerIndex"];
  newTickUpperIndex: RepositionLiquidityInstructionDataArgs["newTickUpperIndex"];
  newLiquidityAmount: RepositionLiquidityInstructionDataArgs["newLiquidityAmount"];
  tokenMinA: RepositionLiquidityInstructionDataArgs["tokenMinA"];
  tokenMinB: RepositionLiquidityInstructionDataArgs["tokenMinB"];
  tokenMaxA: RepositionLiquidityInstructionDataArgs["tokenMaxA"];
  tokenMaxB: RepositionLiquidityInstructionDataArgs["tokenMaxB"];
  remainingAccountsInfo: RepositionLiquidityInstructionDataArgs["remainingAccountsInfo"];
};

export function getRepositionLiquidityInstruction<
  TAccountWhirlpool extends string,
  TAccountTokenProgramA extends string,
  TAccountTokenProgramB extends string,
  TAccountMemoProgram extends string,
...
>(
  input: RepositionLiquidityInput<
    TAccountWhirlpool,
    TAccountTokenProgramA,
    TAccountTokenProgramB,
    TAccountMemoProgram,
...
): RepositionLiquidityInstruction<
  TProgramAddress,
  TAccountWhirlpool,
  TAccountTokenProgramA,
  TAccountTokenProgramB,
...
> {
  ...
  return Object.freeze({
    ...
    data: getRepositionLiquidityInstructionDataEncoder().encode(
      args as RepositionLiquidityInstructionDataArgs,
    ),
    programAddress,
  } as RepositionLiquidityInstruction<
    TProgramAddress,
    TAccountWhirlpool,
    TAccountTokenProgramA,
    TAccountTokenProgramB,
...
export type ParsedRepositionLiquidityInstruction<
  TProgram extends string = typeof WHIRLPOOL_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RepositionLiquidityInstructionData;
};

export function parseRepositionLiquidityInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedRepositionLiquidityInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRepositionLiquidityInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
